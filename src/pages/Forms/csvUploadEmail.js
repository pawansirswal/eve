...
class CsvUploadforNewsletterforEmail extends Component {
  constructor(props) {
    super(props);
  ...
  csvUpload = () => {
    if (this.state.selectedFiles.length !== 0) {
      if (this.state.selectedFiles[0].name.slice(-3) !== "csv") {
        ...
        fetch(API.api_route + "/csv/uploadfiletoemail", requestOptions)
...
export default CsvUploadforNewsletterforEmail;
